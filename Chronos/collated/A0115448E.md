...
.overdue {
	...
	-fx-background-position: 260 center;
}
...
.overdueHaveNotes {
	...
	-fx-background-repeat: stretch; 
	-fx-background-position: 260 center, 485 center;
}
...
.alarmOverdue{
	...
	-fx-background-size: 20 25,15 15;
	-fx-background-repeat: stretch; 
	-fx-background-position: 260 center, 470 center;
}
...
.alarmOverdueHaveNotes{
	...
	-fx-background-repeat: stretch; 
	-fx-background-position: 260 center, 470 center, 485 center;
}
...
=======
							<TableColumn fx:id="EventTimeCol" prefWidth="110.0" text="start time" />
							<TableColumn fx:id="EventEndTimeCol" prefWidth="110.0" text="end time" />
							<TableColumn fx:id="EventTitleCol" prefWidth="255.0" text="title" />
>>>>>>> cc1e59311bdc60e6a7d55c6f00857e147be17fc9
...
=======
							<TableColumn fx:id="TaskTimeCol" prefWidth="220.0" text="time" />
							<TableColumn fx:id="TaskTitleCol" prefWidth="255.0" text="title" />
>>>>>>> cc1e59311bdc60e6a7d55c6f00857e147be17fc9
